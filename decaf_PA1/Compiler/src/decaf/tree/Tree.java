...
public abstract class Tree {
     ...
     * A repeat until loop
     * */
    public static class RepeatUntilLoop extends Tree
    {
    	public Expr condition;
    	public Tree loopBody;
    	
		public RepeatUntilLoop(Expr condition, Tree loopBody, Location loc)
		{
...
//    }
    ...
    public static abstract class Visitor {
        ...
        public void visitRepeatUntilLoop(RepeatUntilLoop that)
		{
			// TODO Auto-generated method stub
        	visitTree(that);
		}
